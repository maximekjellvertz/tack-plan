  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-6",
        caption: "flex justify-between items-center pt-3 relative mb-6 w-full px-2",
        caption_label: "hidden",
        caption_dropdowns: "flex gap-4 items-center justify-center flex-1",
        dropdown_month: "px-6 py-3 text-base font-bold border-2 rounded-2xl hover:bg-primary hover:text-primary-foreground hover:scale-105 transition-all bg-card shadow-2xl cursor-pointer relative min-w-[140px] overflow-hidden",
        dropdown_year: "px-6 py-3 text-base font-bold border-2 rounded-2xl hover:bg-primary hover:text-primary-foreground hover:scale-105 transition-all bg-card shadow-2xl cursor-pointer relative min-w-[120px] overflow-hidden",
        dropdown: "w-full h-full opacity-100 cursor-pointer appearance-none bg-card text-center font-bold pointer-events-auto absolute inset-0",
        nav: "contents",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-11 w-11 bg-gradient-to-br from-card to-card/80 p-0 border-2 hover:bg-primary hover:text-primary-foreground hover:scale-110 transition-all shadow-xl font-bold rounded-xl",
        ),
        nav_button_previous: "",
        nav_button_next: "",
